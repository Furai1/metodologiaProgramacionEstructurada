...
namespace Calculo_bonificaciones
{
    public partial class Form1 : Form
    {
        ...
        {
            int cursorPosition = TXTsalariobasico.SelectionStart;

            string textoSinFormato = TXTsalariobasico.Text.Replace(",", "");

            if (decimal.TryParse(textoSinFormato, out decimal numero))
            {
                TXTsalariobasico.Text = numero.ToString("N0");

                TXTsalariobasico.SelectionStart = TXTsalariobasico.TextLength;
            }
        }
        ...
        private void TXTsalariobasico_KeyPress(object sender, KeyPressEventArgs e)
        {
